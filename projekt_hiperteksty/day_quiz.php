...
// Wylosuj quiz dnia
$sql = "SELECT category_id, category_name FROM categories ORDER BY RAND() LIMIT 1";
$result = mysqli_query($conn, $sql);

$random_quiz = mysqli_fetch_assoc($result);
?>
<!DOCTYPE html>
<html lang="pl">
    ...
    <section class="main-section">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <!-- Sekcja z losowym quizem -->
                <div class="row mt-4 justify-content-center">
                    <h3 class="text-center mt-5">Quiz dnia</h3>
                    <div class="col-md-6">
                        <div class="card quiz-card">
                            <img src="img/quiz_day.jpg" alt="Quiz dnia">
                            <div class="card-body text-center">
                                <h3 class="card-title"><?php echo $random_quiz['category_name']; ?></h3>
                                <a href="quiz.php?category_id=<?php echo $random_quiz['category_id']; ?>"
                                    class="btn btn-warning m-1">Start</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-6 justify-content-center">
                <h3 class="text-center mt-5">Wybierz kategorię</h3>
                <div class="row g-3">
                    <div class="col-md-4">
